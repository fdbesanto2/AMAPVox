...
import fr.amap.lidar.format.shot.Shot;
 ...
 */
public class ShotWriter2 {

    private final ShotFileContext context;
    private final BufferedWriter writer;
    private final DecimalFormat formatter = new DecimalFormat("###.#######################");
    
    public ShotWriter2(ShotFileContext context, File file) throws IOException {
        ...
        String attributesTypesLine = "INTEGER DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE";
        String attributesLine = "shotID shotTimeStamp xOrigin yOrigin zOrigin xDirection yDirection zDirection range";
    ...
    public void write(Shot shot, double shotTimeStamp) throws IOException{
        ...
        if(shot.getNbEchoes() > 0){
            ...
            writer.write(shot.getId()+" "+ shotTimeStamp + " "+
                        formatter.format(shot.getXOrigin())+" "+formatter.format(shot.getYOrigin())+" "+formatter.format(shot.getZOrigin())+" "+
                        formatter.format(shot.getXDirection())+" "+formatter.format(shot.getYDirection())+" "+formatter.format(shot.getZDirection())+"\n");
        }
