...
public class OldVoxelAnalysis extends AbstractVoxelAnalysis {

    public OldVoxelAnalysis(Raster terrain, VoxelAnalysisCfg cfg) throws Exception {
        super(terrain, cfg);
    }

    private final static Logger LOGGER = Logger.getLogger(OldVoxelAnalysis.class);
    ...
    private void propagate(Point3d origin, Point3d echo, double beamFraction, double residualEnergy, boolean lastEcho, int shotID, Shot shot, boolean keepEcho) {
        ...
        while ((context != null) && (context.indices != null)) {
            ...
            // ray length is the distance between entering point of current
            // voxel and entering point of next voxel
