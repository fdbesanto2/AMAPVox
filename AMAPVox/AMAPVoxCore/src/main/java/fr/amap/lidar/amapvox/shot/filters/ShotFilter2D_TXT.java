 ...
 * @author claudia
 */
public class ShotFilter2D_TXT implements Iterable<Shot> {
     ...
     * @param shotIterator
     */
    public ShotFilter2D_TXT(Iterator<Shot> shotIterator) {
     ...
     */
    public ShotFilter2D_TXT(Iterator<Shot> shotIterator, int filteringWindowLength, double minRange) {
...
//                }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // TXT READER:
        //ShotReader shotReader = new ShotReader(new File("/home/claudia/DATA/testsPochette/InputFiles/700101_010355_Pochette70cm_1.0.5.rxp.txt"));
        ShotReader shotReader = new ShotReader(new File("/media/claudia/Transcend/DATA/CorrFauxTirsVides/TestsPochette/InputFiles/Pochette70cm_UnitTest.txt"));
        ...
        //BufferedWriter writer = new BufferedWriter(new FileWriter(new File("/home/claudia/DATA/testsPochette/OutputFiles/700101_010355_Pochette70cm_1.0.5_Filter2DAMAPVoxTXT.txt")));
        BufferedWriter writer = new BufferedWriter(new FileWriter(new File("/media/claudia/Transcend/DATA/CorrFauxTirsVides/TestsPochette/OutputFiles/Pochette70cm_UnitTest_Filter2DAMAPVoxTXT.txt")));
        ...
        if(DEBUG){
            System.out.println("nb Of initial TXTShots=" + nbOfInitialShots);
            System.out.println("nb Of remaining TXTShots=" + count);
        }
