// $Id: rxpmarker.hpp 651 2012-03-19 11:55:28Z RS $
...
public:
    ...
    encoder_rxpmarker(
        ...
        , size_type size = 65536
        , size_type headroom = 32768
        , bool with_preamble = true
    );

    encoder_rxpmarker(
        std::tr1::shared_ptr<basic_wconnection> wconnection
        , size_type size = 65536
        , size_type headroom = 32768
        , bool with_preamble = true
    )
...
private:
    ...
    buffer auto_buffer;
    std::tr1::shared_ptr<basic_wconnection> owned_wconnection;
...
private:
    ...
    buffer auto_buffer;
    std::tr1::shared_ptr<basic_rconnection> owned_rconnection;
