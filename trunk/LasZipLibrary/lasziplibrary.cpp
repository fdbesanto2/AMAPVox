...
JNIEXPORT void JNICALL Java_fr_ird_voxelidar_voxelisation_extraction_als_LazExtraction_afficherBonjour(JNIEnv *env, jobject obj)
{
    printf(" Bonjour\n ");
    return;
}
...
JNIEXPORT long JNICALL Java_fr_ird_voxelidar_voxelisation_extraction_als_LazExtraction_instantiateLasZip(JNIEnv *env, jobject obj)
{
    ...
    jclass c = env->FindClass("fr/ird/voxelidar/voxelisation/als/LasPoint");
    if (c == NULL){
        return -1;
    }
...
JNIEXPORT void JNICALL Java_fr_ird_voxelidar_voxelisation_extraction_als_LazExtraction_readAllPoints(JNIEnv *, jobject, jlong pointer)
{
    long pointerAddress = pointer;
    laszip_dll_struct* laszip_dll = (laszip_dll_struct*)pointerAddress;
...
JNIEXPORT jobject JNICALL Java_fr_ird_voxelidar_voxelisation_extraction_als_LazExtraction_getNextPoint(JNIEnv *env, jobject obj, jlong pointer)
{
    long pointerAddress = pointer;
    laszip_dll_struct* laszip_dll = (laszip_dll_struct*)pointerAddress;
...
JNIEXPORT jobject JNICALL Java_fr_ird_voxelidar_voxelisation_extraction_als_LazExtraction_getBasicHeader(JNIEnv *env, jobject obj, jlong pointer)
{
    long pointerAddress = pointer;
    laszip_dll_struct* laszip_dll = (laszip_dll_struct*)pointerAddress;


    jclass lasHeaderClass = env->FindClass("fr/ird/voxelidar/lidar/format/als/LasHeader");
