...
public class JFrameTools extends javax.swing.JFrame {
     ...
     * @param joglContext
     */
    public JFrameTools(JoglListener joglContext, ListAdapterComboboxModel model) {
    ...
    public void setMapAttributs(Map<String, Attribut> mapAttributs) {
        joglContext.getSettings().extendedMapAttributs = mapAttributs;
        fillComboBox();
    }
    ...
    private void jButtonCreateAttributActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreateAttributActionPerformed
        ...
        jframeAttribut.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent evt) {
                ...
                String[] variablesNames = new String[model.getSize()];
                for(int i=0;i<model.getSize();i++){
                    variablesNames[i] = model.getElementAt(i).toString();
                ...
                for(int i=0;i<model.getSize();i++){
                    ...
                    joglContext.getScene().getVoxelSpace().addAttribut(model.getElementAt(i).toString(), model.getValue(i));
                }
    ...
    private void jComboBoxAttributeToVisualizeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxAttributeToVisualizeItemStateChanged
        ...
        if((evt.getStateChange()== ItemEvent.SELECTED)&& temp){
            ...
            joglContext.getScene().getVoxelSpace().changeCurrentAttribut(jComboBoxAttributeToVisualize.getSelectedItem().toString());
    ...
    private void fillComboBox() {
        jComboBoxAttributeToVisualize.setModel(new DefaultComboBoxModel(joglContext.getSettings().extendedMapAttributs.keySet().toArray()));
