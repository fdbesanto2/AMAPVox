...
import fr.amap.commons.util.configuration.Configuration.InputType;
import static fr.amap.commons.util.configuration.Configuration.InputType.LAS_FILE;
import static fr.amap.commons.util.configuration.Configuration.InputType.LAZ_FILE;
import static fr.amap.commons.util.configuration.Configuration.InputType.POINTS_FILE;
import static fr.amap.commons.util.configuration.Configuration.InputType.RSP_PROJECT;
import static fr.amap.commons.util.configuration.Configuration.InputType.RXP_SCAN;
import static fr.amap.commons.util.configuration.Configuration.InputType.SHOTS_FILE;
