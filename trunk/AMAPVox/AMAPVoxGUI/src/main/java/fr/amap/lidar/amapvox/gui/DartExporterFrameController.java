...
public class DartExporterFrameController implements Initializable {
    ...
    final Logger logger = LoggerFactory.getLogger(DartExporterFrameController.class);
            ...
            protected Task<Void> createTask() {
                return new Task<Void>() {
                    ...
                    protected Void call() throws InterruptedException {
                        ...
                        Mat4D transfMatrix = MatrixUtility.convertMatrix4dToMat4D(vopMatrix);
                        ...
                        try {
                            dartWriter.writeFromVoxelFile(voxelFile, maketFile);
                        } catch (Exception ex) {
                            logger.error("Cannot write dart files", ex);
                        }
