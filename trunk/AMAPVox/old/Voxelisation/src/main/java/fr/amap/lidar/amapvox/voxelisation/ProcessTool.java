...
public class ProcessTool extends Process implements Cancellable{
    ...
    public ArrayList<File> voxeliseFromPTG(TLSVoxCfg cfg) throws Exception{
    ...
    public ArrayList<File> voxeliseFromPTX(TLSVoxCfg cfg) throws Exception{
    ...
    public ArrayList<File> voxeliseFromRsp(TLSVoxCfg cfg) throws Exception{
