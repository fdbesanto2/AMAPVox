...
import fr.amap.viewer3d.renderer.GLRenderFrame;
import fr.amap.viewer3d.renderer.MinimalWindowAdapter;
import fr.amap.viewer3d.renderer.JoglListener;
import fr.amap.viewer3d.renderer.MinimalKeyAdapter;
import fr.amap.viewer3d.renderer.MinimalMouseAdapter;
...
public class SimpleViewer {
    ...
    public fr.amap.viewer3d.object.scene.Scene getScene(){
