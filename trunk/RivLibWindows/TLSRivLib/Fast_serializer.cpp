...
Fast_serializer::Fast_serializer(JNIEnv *env, jmethodID method, jmethodID addShotMethod, jmethodID callConstructorMethod, jclass shotClass, jobject shots, ostream& st, shotfilter& filter) :serializer(st, filter)
{
	this->env = env;
	this->method = method;
