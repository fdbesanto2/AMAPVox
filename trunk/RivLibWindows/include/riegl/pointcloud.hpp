// $Id: pointcloud.hpp 1154 2015-01-19 11:22:50Z RS $
...
#ifdef BUILD_RIVMTA
    void set_rivmta_params(float mod_depth, float max_range, float zone_width, float line_increment, size_t mod_length); //!< INTERNAL ONLY
    virtual void on_echo_mta(target* t, echo_type echo, scanlib::uint8_t confidence); //!< INTERNAL ONLY
#endif
