...
public class VoxelSpaceHeader {
    ...
    private final Logger logger = Logger.getLogger(VoxelSpaceHeader.class);
    ...
    public static VoxelSpaceHeader readVoxelFileHeader(File f){
        ...
        if(header.equals("VOXEL SPACE")){
            ...
            try(BufferedReader reader = new BufferedReader(new FileReader(f))) {
                ...
                if(type.equals("ALS")){
                    voxelSpaceHeader.type = fr.ird.voxelidar.engine3d.object.scene.VoxelSpaceData.Type.ALS;
                }else{
                    voxelSpaceHeader.type = fr.ird.voxelidar.engine3d.object.scene.VoxelSpaceData.Type.TLS;
                }
