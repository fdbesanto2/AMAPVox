...
import fr.ird.voxelidar.lidar.format.raster.BCommon.ByteOrder;
import fr.ird.voxelidar.lidar.format.raster.BCommon.Layout;
import fr.ird.voxelidar.lidar.format.raster.BCommon.NumberOfBits;
import fr.ird.voxelidar.lidar.format.raster.BCommon.PixelType;
