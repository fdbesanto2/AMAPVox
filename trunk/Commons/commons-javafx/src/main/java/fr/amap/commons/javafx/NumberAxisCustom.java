 ...
 */
package fr.amap.commons.javafx;
 ...
 * @since JavaFX 2.0
 */
public final class NumberAxisCustom extends ValueAxis<Number> {
    ...
    private DoubleProperty tickUnit = new StyleableDoubleProperty(5) {
        ...
        @Override
        public CssMetaData<NumberAxisCustom,Number> getCssMetaData() {
    ...
    /**
     * Create a auto-ranging NumberAxisCustom
     */
    public NumberAxisCustom() {}

    /**
     * Create a non-auto-ranging NumberAxisCustom with the given upper bound, lower bound and tick unit
     *
     ...
     */
    public NumberAxisCustom(double lowerBound, double upperBound, double tickUnit) {
     ...
     * @param tickUnit The tick unit, ie space between tickmarks
     */
    public NumberAxisCustom(String axisLabel, double lowerBound, double upperBound, double tickUnit) {
        super(lowerBound, upperBound);
        setTickUnit(tickUnit);
        setLabel(axisLabel);
    }
    ...
    @Override protected List<Number> calculateTickValues(double length, Object range) {
        ...
        if (lowerBound == upperBound) {
            ...
            /*if (((upperBound - lowerBound) / tickUnit) > 2000) {
                ...
                System.err.println("Warning we tried to create more than 2000 major tick marks on a NumberAxisCustom. " +
    ...
    protected List<Number> calculateMinorTickMarks() {
        ...
        if (tickUnit > 0) {
            /*if(((upperBound - lowerBound) / minorUnit) > 10000) {
                // This is a ridiculous amount of major tick marks, something has probably gone wrong
                System.err.println("Warning we tried to create more than 10000 minor tick marks on a NumberAxisCustom. " +
    ...
    private static class StyleableProperties {
        private static final CssMetaData<NumberAxisCustom,Number> TICK_UNIT =
            new CssMetaData<NumberAxisCustom,Number>("-fx-tick-unit",
                SizeConverter.getInstance(), 5.0) {

            @Override
            public boolean isSettable(NumberAxisCustom n) {
                return n.tickUnit == null || !n.tickUnit.isBound();
            }

            @Override
            public StyleableProperty<Number> getStyleableProperty(NumberAxisCustom n) {
    ...
    /**
     * Default number formatter for NumberAxisCustom, this stays in sync with auto-ranging and formats values appropriately.
    ...
    public static class DefaultFormatter extends StringConverter<Number> {
        ...
        /**
         * Construct a DefaultFormatter for the given NumberAxisCustom
         *
         * @param axis The axis to format tick marks for
         */
        public DefaultFormatter(final NumberAxisCustom axis) {
        ...
        /**
         * Construct a DefaultFormatter for the given NumberAxisCustom with a prefix and/or suffix.
         *
         * @param axis The axis to format tick marks for
         ...
         */
        public DefaultFormatter(NumberAxisCustom axis, String prefix, String suffix) {
            this(axis);
            this.prefix = prefix;
            this.suffix = suffix;
        }
