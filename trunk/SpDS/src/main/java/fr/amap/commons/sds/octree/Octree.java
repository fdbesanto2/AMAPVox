...
package fr.amap.commons.sds.octree;
...
public class Octree<T extends Point3D>{
     ...
     * @return 
     */
    public T isPointBelongsToPointcloud(Point3D point, float errorMargin, short type){
        ...
        if(incrementalSearchNearestPoint != null){
            ...
            if(distance < errorMargin){
                nearestPoint = incrementalSearchNearestPoint;
            }
        }
