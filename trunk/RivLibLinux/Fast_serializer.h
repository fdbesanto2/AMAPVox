...
{
	public:
        Fast_serializer(JNIEnv *env, jmethodID method, jmethodID addShotMethod, jmethodID callConstructorMethod, jclass shotClass, jobject shots, std::ostream& st, shotfilter& filter);
