...
public class TriangulatedMesh extends Shape{
	...
	public TriangulatedMesh(Point3f[] points, int[][] paths, boolean culling) {
		...
		this.normals	= new Vector3f[paths.length];
		computeNormals();
	}
	...
	public Object clone() {
	    ...
	    tri.culling = culling;
	    tri.normals = new Vector3f[normals.length];
	    for (int i = 0 ; i < normals.length ; i++)
	    	tri.normals[i] = new Vector3f (normals[i]);
	...
	private IntersectionContext computeIntersection (int tri, Vector3f direction, Point3f origin, boolean cullingDesired, boolean allowNegativeLengths) {
		...
		****************************************************************************************************/
		...
		Vector3f edge1 = new Vector3f(	point1.x-point0.x,
										point1.y-point0.y,
										point1.z-point0.z);
		Vector3f edge2 = new Vector3f(	point2.x-point0.x,
										point2.y-point0.y,
										point2.z-point0.z);
