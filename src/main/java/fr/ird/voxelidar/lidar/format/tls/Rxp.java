...
public class Rxp {
    ...
    private Map<Integer, Scan> scanList;
    ...
    public void setScanList(Map<Integer,Scan> scanList) {
    ...
    public Map<Integer, Scan> getScanList() {
        return Collections.unmodifiableMap(scanList);
    }
    
    public Map<Integer, Scan> getScanListFiltered(boolean lite) {
        
        Map<Integer, Scan> result = new HashMap<>();
