...
public class ShapeUtils {
	 ...
	 */
	public static ConvexMesh createRectangleBox(BoundingBox3f boundingBox, double margin, boolean culling) {
	 ...
	 */
	public static BoundingBox3f getPaddedBoundingBox(BoundingBox3f bbox, double margin) {
