 ...
 * @author Julien
 */
public class PreprocessingLas extends Preprocessing {
    ...
    public PreprocessingLas(Las las, Mat4D popMatrix, File trajectoryFile) {
    ...
    private ArrayList<Las2> readTxt() {
        ...
        try {
            ...
            Logger.getLogger(PreprocessingLas.class.getName()).log(Level.SEVERE, null, ex);
    ...
    */
    private ArrayList<LasMixTrajectory> transformPoints(Mat4D transfMatrix, ArrayList<LasPoint> lasPointList, File trajectoryFile) {
        ...
        try {
            ...
            Logger.getLogger(PreprocessingLas.class
